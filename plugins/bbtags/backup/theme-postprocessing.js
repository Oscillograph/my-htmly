...
// bigmath
/*
tagCollection = document.getElementsByTagName('bigmath');
var tempStr;
var numberAttribute;
while (tagCollection.length > 0)
{
	tempStr = tagCollection[0].innerHTML;
	numberAttribute = tagCollection[0].getAttribute('number');
	if (numberAttribute == null)
	{
		tagCollection[0].outerHTML = '<table><tr><td>' + tempStr + '</td><td style="text-align:left"> &nbsp; </td></tr></table>';
	} else {
		tagCollection[0].outerHTML = '<table><tr><td>' + tempStr + '</td><td style="text-align:left">(' + numberAttribute + ')</td></tr></table>';
	}
}
*/
